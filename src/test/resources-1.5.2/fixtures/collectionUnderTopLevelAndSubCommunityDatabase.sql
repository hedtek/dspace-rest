...
SELECT pg_catalog.setval('collection_seq', 3, true);
...
SELECT pg_catalog.setval('community2collection_seq', 3, true);
...
SELECT pg_catalog.setval('epersongroup_seq', 6, true);
...
SELECT pg_catalog.setval('resourcepolicy_seq', 20, true);
