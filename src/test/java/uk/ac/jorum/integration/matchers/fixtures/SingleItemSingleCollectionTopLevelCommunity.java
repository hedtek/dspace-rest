...
public class SingleItemSingleCollectionTopLevelCommunity {
	...
	public static final Matcher<JSONObject> owningCollection = isCollection(1, "Collection 1", "123456789/6",
	...
	public static final Matcher<JSONObject> submitter =  isUser(1, "dspace", "dspace", "dspace@example.com");
	
	public static final Matcher<JSONObject> bitstream = isBitstream(1, "firstUpload.txt", "Text", "text/plain", bundleIdMatchers);
	...
	public static final Matcher<JSONObject> bundle1 = isBundle(1, "ORIGINAL", itemListWithIdMatchers, bitstreamIdMatchers);
	public static final Matcher<JSONObject> bundle2 = isBundle(2, "LICENSE", itemListWithIdMatchers, bitstreamIdMatchers);
	...
	public static final Matcher<JSONObject> item = isItem(1, 
