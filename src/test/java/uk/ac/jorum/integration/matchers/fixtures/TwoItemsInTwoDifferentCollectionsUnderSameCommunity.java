...
public class TwoItemsInTwoDifferentCollectionsUnderSameCommunity {
	...
	public static final Matcher<JSONObject> owningCollectionForFirstItem = isCollection(1, "Collection 1", "123456789/6",
			...
			"Provenance for collection 1", 1, communityListIdMatchers, itemIdMatchersFirstCollection);

	public static final Matcher<JSONObject> owningCollectionForSecondItem = isCollection(2, "Collection 2", "123456789/7",
			...
			"Provenance text for collection 2", 1, communityListIdMatchers, itemIdMatchersSecondCollection);
	...
	public static final Matcher<JSONObject> firstItem = isItem(1, "First Upload",
			"123456789/8", true, false, owningCollectionForFirstItem, submitter,
			communityListMatchers, collectionListMatchersForFirstItem, bundleMatchersForItem1, bitstreamMatchersForItem1);

	public static final Matcher<JSONObject> secondItem = isItem(2, "Second Upload",
			"123456789/9", true, false, owningCollectionForSecondItem, submitter,
			communityListMatchers, collectionListMatchersForSecondItem, bundleMatchersForItem2, bitstreamMatchersForItem2);
